...
function OtpModal({  isOpen, onClose, onVerify, onResend, mobile, setOtpModalOpen,setIsOtpVerified}) {
  ...
  const handleVerify = async (otp) => {
    ...
    // const verificationUrl =`https://testapproval.bhima.info/api_db.js/api//Validateotp/${mobile}/${otp}`;
...
const claimCoupon = async () => {
  ...
  <div class="card textbox" style={{borderColor:"black" ,marginBottom:"80px"}} padding="15px">
  <div class="card-body">
