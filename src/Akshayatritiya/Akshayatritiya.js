...
import { AT_IMG } from '../components/Utils/imagePath';
...
import { getSendOtpUrl, getValidateOtpUrl, getCouponDetailsUrl, AKBASE_URL } from '../components/Utils/apiUrls';
...
function App() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const apiUrl = getSendOtpUrl(mobile);
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="banner-container">
              <img src={AT_IMG.banner} alt="Background" className="desktop-banner img-fluid" />
              <img src={AT_IMG.mbBanner} alt="Mobile Background" className="mobile-banner img-fluid" />
            </div>
          </div>
        </div>
